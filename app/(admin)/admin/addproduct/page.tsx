      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div
            ...
            className="bg-gray-100 w-[500px] h-[50px] flex items-center justify-center text-black/70 rounded-md cursor-pointer"
          >
        ...
        <button
          type="submit"
          className="p-2 m-2 bg-green-300 rounded-lg font-bold"
        >
          Add Product{" "}
        </button>
      </form>
